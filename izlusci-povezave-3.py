...
seznam_filmov = set()
html_datoteke = './zajeti-podatki/ocene-filmov/'
...
for film in seznam_filmov:
    ime_datoteke = 'zajeti-podatki/filmi-cast/stran' + film.replace('/', '-') + '.html'
    spletna_stran = f'https://www.allmovie.com{film}/cast-crew'
